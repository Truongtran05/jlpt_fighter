...
urlpatterns = [
   ...
   path("flashcard-sets/", views.FlashCardSetCreateView.as_view(), name="flashcardset"), 
    ...
    #get all flashcards or create a new flashcard for a specific flashcard set (GET-POST)
    ...
    path("flashcard-sets/<flash_card_set_id>/flashcards/<flash_card_id>/", views.FlashCardUpdateView.as_view(), name="flashcarddelete-detail"),
]